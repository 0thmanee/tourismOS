...
export function PartnerCertificateDocument({
	data,
}: {
			...
			<Page size="A4" style={styles.page}>
				...
				<View style={styles.header}>
					...
					<Text style={styles.tagline}>
						Tourism operator inbox & booking workflow
					</Text>
				...
				<Text style={styles.subtitle}>
					This document certifies a registered partner on the TourismOS
					platform.
				</Text>
				...
				<View style={styles.card}>
					...
					<View style={styles.row}>
						...
						<Text style={[styles.value, styles.partnerId]}>
							{data.partnerId}
						</Text>
					</View>
					<View style={styles.row}>
				...
				<View style={styles.footer}>
					...
					<Text style={styles.footerRight}>
						Document generated from TourismOS platform
					</Text>
				</View>
			</Page>
		</Document>
